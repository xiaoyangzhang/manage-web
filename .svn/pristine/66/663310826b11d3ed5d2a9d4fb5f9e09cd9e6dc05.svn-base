        ...
        <div class="layui-form-item" >
            <div class="layui-input-block">
                ...
                <c:if test="${article.isQuote==1}">
                    <input type="text" style="display: none;" name="quoteUrl" value="${article.quoteUrl}" placeholder="请输入有效的https链接" class="layui-input" >
                </c:if>
                <c:if test="${article.isQuote==2}">
                    <input type="text"  name="quoteUrl" value="${article.quoteUrl}" placeholder="请输入有效的https链接" class="layui-input" >
                </c:if>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
                ...
                <div class="defineCon">
                    <div class="site-demo-upload">
                        ...
                        <div class="site-demo-upbar">
                            <input type="file" lay-method="post" name="file" lay-title="请上传小于100K的图片" lay-type="images" class="layui-upload-file" id="addImg">
...
<script>
    ...
    var isQuote = '${article.isQuote}';//默认内容详情是引用外部链接
