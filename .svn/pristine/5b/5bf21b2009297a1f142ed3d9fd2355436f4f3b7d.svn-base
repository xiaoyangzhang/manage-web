...
<div class="layui-clear">
    ...
    <div style="float: left;width: 45%;height: 95%;margin: 5px;">
        <p >疾病列表</p>
        <iframe width="100%" height="100%" id="listFrame" src="<%=staticPath%>/department/toDiseaseList/${id}"></iframe>
    </div>
    <div style="float: right;width: 45%;height: 95%;margin: 5px;">
        <p >已添加疾病列表</p>
        <iframe width="100%" height="100%" id="addedFrame" src="<%=staticPath%>/department/toDiseaseAddList/${id}"></iframe>
    </div>
</div>
