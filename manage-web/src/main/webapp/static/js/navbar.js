/**
 * navbar.js By Beginner Emain:zheng_jinfan@126.com
...
layui.define(['element', 'common'], function(exports) {
	...
	var $ = layui.jquery, layer = parent.layer === undefined
			? layui.layer
			: parent.layer, element = layui.element(), common = layui.common, cacheName = 'tb_navbar';
	...
	function getHtml(data) {
		...
		for (var i = 0; i < data.length; i++) {
			...
			if (data[i].children !== undefined && data[i].children !== null
				...
				var dataUrl = (data[i].href !== undefined && data[i].href !== '')
						? 'data-url="' + data[i].href + '"'
						: '';
