...
<div style="margin:0px; background-color: white;" class="layui-whole">
    <blockquote class="layui-elem-quote">
        <form class="layui-form">
            ...
            <div class="layui-form-item" style="margin:0;">
                ...
                <div class="layui-form-mid layui-word-aux"  style="padding:0;float: right;position: relative;z-index: 1000;">
                    <a href="javascript:" id="oneKeyAdd" class="layui-btn layui-btn-normal" >一键添加</a>
                </div>
                    ...
                    $(this).children('td:last-child').children('input').each(function () {
                        ...
                        $that.on('click', function () {
                            ...
                            if (!isExist)
                                ...
                                $.ajax({
                                    url: '<%=staticPath%>/department/addDisease2Dept/' + id + '/' + $("#deptId").val(),
                                    type: "get",
                                    dataType: 'json',
//                                contentType:'application/json',
        ...
        //一键添加
        $('#oneKeyAdd').on('click',function () {
            console.log("一键添加");
            $.ajax({
               url:'<%=staticPath%>/department/oneKey/add/'+$('#deptId').val(),
               dataType:'json',
               type:'get',
                success:function (result) {
                    if (result.code==200){
