...
<body>
<blockquote class="layui-elem-quote" style="padding: 10px 15px;line-height: 30px;">当前位置:编辑问卷<a href="javascript:history.back(-1);" style="float: right;height: 30px;line-height: 30px;" class="layui-btn layui-btn-normal">返回</a></blockquote>
<form class="layui-form layui-form-pane" action="">
    ...
    <div class="layui-whole-title" style="padding:0 15px;">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="title" lay-verify="title" value="${questionnaire.title}" autocomplete="off" placeholder="请输入标题" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">副标题</label>
            <div class="layui-input-block">
                <input type="text" name="subTitle" lay-verify="subtitle" value="${questionnaire.subTitle}" placeholder="请输入副标题" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <!--标题 end-->
            ...
            <c:forEach items="${questionnaireItems}"  var="item" varStatus="status">
                ...
                <c:if test="${item.type==1}">
                    <fieldset class="layui-elem-field site-demo-button">
                        <legend>题目${status.index+1}</legend>
                        <div class="questions-mar10 questions-radio">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="desc" data-type="1" value="${item.title}" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                        <input type="checkbox" name="isNecessary" <c:if test="${item.isNecessary==1}">checked</c:if> title="非必填题">
                            ...
                            <%--选项--%>
                                <c:if test="${!empty item.answerA}">
                                    <div class="layui-form-item answer-item">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" lay-verify="optiontitle" value="${item.answerA}" placeholder="请输入选项" autocomplete="off" class="layui-input">
                                        </div>
                                ...
                                <div class="layui-form-item answer-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" lay-verify="optiontitle" value="${item.answerB}" placeholder="请输入选项" autocomplete="off" class="layui-input">
                                    </div>
                                    <a class="layui-btn layui-btn-danger" onclick=deleteAnswer(this)>删除</a>
                                </div>
                                </c:if>
                           <c:if test="${!empty item.answerC}">
                                <div class="layui-form-item answer-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" lay-verify="optiontitle" value="${item.answerC}" placeholder="请输入选项" autocomplete="off" class="layui-input">
                                    </div>
                                    <a class="layui-btn layui-btn-danger" onclick=deleteAnswer(this)>删除</a>
                                </div>
                                </c:if>
                           <c:if test="${!empty item.answerD}">
                                <div class="layui-form-item answer-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" lay-verify="optiontitle" value="${item.answerD}" placeholder="请输入选项" autocomplete="off" class="layui-input">
                                    </div>
                                    <a class="layui-btn layui-btn-danger" onclick=deleteAnswer(this)>删除</a>
                                </div>
                                </c:if>
                           <c:if test="${!empty item.answerE}">
                                <div class="layui-form-item answer-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" lay-verify="optiontitle" value="${item.answerE}" placeholder="请输入选项" autocomplete="off" class="layui-input">
                                    </div>
                                    <a class="layui-btn layui-btn-danger" onclick=deleteAnswer(this)>删除</a>
                                </div>
                                </c:if>
                           <c:if test="${!empty item.answerF}">
                                <div class="layui-form-item answer-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" lay-verify="optiontitle" value="${item.answerF}" placeholder="请输入选项" autocomplete="off" class="layui-input">
                                    </div>
                                    <a class="layui-btn layui-btn-danger" onclick=deleteAnswer(this)>删除</a>
                                </div>
                                </c:if>
                            ...
                            <div class="questions-operation">
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="desc" data-type="2" value="${item.title}" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                        <input type="checkbox" name="isNecessary" <c:if test="${item.isNecessary==1}">checked</c:if>  title="非必填题">
                            ...
                            <div class="questions-operation">
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="desc" data-type="3" value="${item.title}" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                        <input type="checkbox" name="isNecessary" <c:if test="${item.isNecessary==1}">checked</c:if>  title="非必填题">
                            ...
                            <div class="questions-operation">
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="desc" data-type="4" value="${item.title}" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                        <input type="checkbox" name="isNecessary" <c:if test="${item.isNecessary==1}">checked</c:if>  title="非必填题">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline" style="width: 100px;">
                                            <input type="text" name="minDescription" value="${item.minDescription}" placeholder="请输入" autocomplete="off" class="layui-input">
                                        </div>
                                        <div class="layui-input-inline" style="width: 100px;"><input min="0" max="10" type="number" value="${item.ratioScope}" name="ratioScope"  class="layui-input"></div>
                                        <div class="layui-input-inline" style="width: 100px;">
                                            <input type="text" name="maxDescription" value="${item.maxDescription}" placeholder="请输入" autocomplete="off" class="layui-input">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="questions-operation">
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="desc"  data-type="5" value="${item.title}" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                        <input type="checkbox" name="isNecessary" <c:if test="${item.isNecessary==1}">checked</c:if>  title="非必填题">
    ...
    <div class="layui-whole-department" style="padding:0 15px;">
        <table class="layui-table" lay-size="lg">
            ...
            <tbody class="tags">
            <tr>
                <td><textarea placeholder="请输入内容" lay-verify="comment"   name="comment" class="layui-textarea">${questionnaire.comment}</textarea></td>
...
<script>
    ...
    var questionnaireDepts2='${questionnaireDepts}';
    var params=JSON.parse(questionnaireDepts2);
    var questionnaireDiseases2='${questionnaireDiseases}';
    var params2=JSON.parse(questionnaireDiseases2);
    //删除题目
...
//                }
        ...
        function extractedDepts() {
            var html = "";
            if(questionnaireDepts2 != null && questionnaireDepts2.length>0) {
                questionnaireDepts2 = JSON.parse(questionnaireDepts2);
                for (var i = 0; i < questionnaireDepts2.length; i++) {
                    html += '<span style="margin:5px;display: inline-block;"><input type="hidden"  value="' + questionnaireDepts2[i].dictDepartmentId + '"/><a  href="javascript:"  class="layui-btn layui-btn-danger layui-btn-xs delDepartment" >' + questionnaireDepts2[i].name + '<i class="layui-icon">&#xe640;</i></a></span>';
                }
            }
            ...
            $('table  .tags').find('.deptTags').children("span").find("a").each(function () {
                ...
                $that.on('click', function () {
                    for (var i = 0; i < questionnaireDepts2.length; i++) {
                        if (Number($that.parent("span").find('input').val()) == questionnaireDepts2[i].dictDepartmentId) {
                            questionnaireDepts2.splice(i, 1);
                        }
                    }
        ...
        function extractedDiseases() {
            var html = "";
            if(questionnaireDiseases2 != null && questionnaireDiseases2.length>0) {
                questionnaireDiseases2 = JSON.parse(questionnaireDiseases2);
                for (var i = 0; i < questionnaireDiseases2.length; i++) {
                    html += '<span style="margin:5px;display: inline-block;"><input type="hidden"  value="' + questionnaireDiseases2[i].dictDiseaseId + '"/><a  href="javascript:"  class="layui-btn layui-btn-danger delDisease" >' + questionnaireDiseases2[i].name + '<i class="layui-icon">&#xe640;</i></a></span>';
                }
            }
            ...
            $('table  .tags').find(' .diseaseTags').children("span").find("a").each(function () {
                ...
                $that.on('click', function () {
                    for (var i = 0; i < questionnaireDiseases2.length; i++) {
                        if (Number($that.parent("span").find('input').val()) == questionnaireDiseases2[i].dictDiseaseId) {
                            questionnaireDiseases2.splice(i, 1);
                        }
                    }
                    $that.parent("span").remove();
                })
...
//            var radio=0,checkbox=0,uploadImg=0,range=0,simpleAnswer=0;
            ...
            $.ajax({
                ...
                success:function (result) {
                    if (result.code==200){
                        layerTips.msg("发布问卷成功",{offset: '100px',icon:1});
                        $("#questionnaireId").val(result.entity);
                        window.history.back(-1);
                    }
                    else {
