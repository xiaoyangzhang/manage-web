...
<script type="text/javascript">
    ...
    function thatpage() {
        window.location = '<%=path%>/index?id=/pages/order/orderdetail';
    }
    ...
    function detailpage(k) {
        ...
        window.location = '<%=path%>/index?backurl=/order/servicecarddetailuser&maindataid=<%=maindataid%>&id=/pages/business/dialogdetail&id1=' + currentid;
