...
layui.config({
	...
	// 清除缓存
	/*
	 * $('#clearCached').on('click', function () { navbar.cleanCached();
	...
	/*
	 * $('#setting').on('click', function () { tab.tabAdd({ href:
	 * '/Manage/Account/Setting/', icon: 'fa-gear', title: '设置' }); });
	 */
	...
	layer.open({
				...
				success : function(layero, lockIndex) {
					...
					layero.find('button#unlock').on('click', function() {
						...
						var userName = $lockBox.find('input[name=username]')
								.val();
